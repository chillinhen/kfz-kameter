...
$lngAct['con_content_list']['con_content']          = i18n('List raw data entries');
$lngAct['con_content_list']['savecontype']          = i18n('Edit raw data entry');
$lngAct['con_content_list']['deletecontype']        = i18n('Delete raw data entry');
