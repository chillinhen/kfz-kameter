...
?>
</title><link rel="stylesheet" type="text/css" href="//localhost:8888/kfz-kameter/contenido/cms/cache/blog.css" id="m21" />
...
<meta name="description" content="CONTENIDO Blog" />
...
if (cRegistry::isBackendEditMode()) {
    $imageEditor = "<img id=\"m14\" src=\"\" alt=\"\" title=\"\" />";
}
...
<teaser><category>56</category><count>6</count><style>cms_teaser_blog.html</style><manual>false</manual><start>false</start><source_head>CMS_HTMLHEAD</source_head><source_head_count>1</source_head_count><source_text>CMS_HTML</source_text><source_text_count>1</source_text_count><source_image>CMS_IMG</source_image><source_image_count>1</source_image_count><filter></filter><sort>creationdate</sort><sort_order>asc</sort_order><character_limit>400</character_limit><image_width>100</image_width><image_height>75</image_height><manual_art></manual_art><image_crop>false</image_crop><source_date>CMS_HTMLHEAD</source_date><source_date_count>2</source_date_count></teaser>
', 3, array());
...
$tpl->assign('image', "");
$tpl->assign('editor', "<img id=\"m15\" src=\"\" alt=\"\" title=\"\" />");
$tpl->display('get.tpl');
...
?>
    ...
    <script src="//localhost:8888/kfz-kameter/contenido/cms/cache/blog.js" type="text/javascript"></script></body>
