...
?>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 vcenter logo-container">
                    <h1><?php
$cCurrentModule = 33;
...
?>
                ...
                <div class="col-md-4 vcenter hidden-sm hidden-xs nav-container">
                    <?php
$cCurrentModule = 8;
...
?>
            ...
            <div id="content" class="row clearfix">
                <div id="slider" class="col-md-12 hidden-xs">
                    <?php
$cCurrentModule = 20;
